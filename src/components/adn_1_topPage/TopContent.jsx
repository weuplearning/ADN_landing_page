...
function TopContent() {
	return <div className='adn-top_content'>
        <div className='adn-top_content-top'>
            ...
            <p className='adn-top_content-top-textcontent'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC,
                ...
                comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also
                reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.
            </p>
        </div>
        <div className='adn-top_content-bottom'>
            <h2 className='adn-top_content-bottom-title'>Titre en lorem ipsum</h2>
            <div className='adn-top_content-bottom-image'>
                simulateur
            </div>
        </div>
    </div>
